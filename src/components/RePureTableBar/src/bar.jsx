...
import { ref, unref, computed, nextTick, defineComponent, getCurrentInstance } from "vue";
...
export default defineComponent({
    ...
    setup(props, { emit, slots, attrs }) {
        ...
        const filterColumns = cloneDeep(props?.columns).filter(column => isBoolean(column?.hide)
            ? !column.hide
        ...
        const dropdown = {
            dropdown: () => (<el-dropdown-menu class="translation">
        ...
        const rowDrop = (event) => {
            ...
            nextTick(() => {
                const wrapper = (instance?.proxy?.$refs[`GroupRef${unref(props.tableKey)}`]).$el.firstElementChild;
        ...
        <div {...attrs} class={[
          ...
          <div class="flex justify-between w-full h-[60px] p-4">
            ...
            <div class="flex items-center justify-around">
              ...
              {props.tableRef?.size ? (<>
                  <ExpandIcon class={["w-[16px]", iconClass.value]} style={{
                    transform: isExpandAll.value ? "none" : "rotate(-90deg)"
                }} v-tippy={rendTippyProps(isExpandAll.value ? "折叠" : "展开")} onClick={() => onExpand()}/>
